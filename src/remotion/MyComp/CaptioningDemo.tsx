// src/remotion/MyComp/CaptioningDemo.tsx
...
import { ForkliftScene, CANVAS_SIZE } from "./ForkliftScene";
import {
  AbsoluteFill,
  useCurrentFrame,
  useVideoConfig,
...
export const CaptioningDemo: React.FC<{
  ...
  const startIndexForSegment = segments
    ...
    return (
      <AbsoluteFill>
        {/* 1. TOP 40% - Caption Zone */}
        <div
          style={{
            position: 'absolute',
            top: '10%',
            width: '100%',
            height: '40%', // 👈 Reduced to 40%
            display: 'flex',
            alignItems: 'center', 
        ...
        {/* 2. BOTTOM 60% - Animation Zone */}
        {/* <div
          style={{
            position: 'absolute',
            bottom: 0,
            width: '100%',
            height: '60%', // 👈 Increased to 60%
            overflow: 'hidden', 
          }}
        >
          <CarDrive 
            preset="tractor" 
            // yBody={350} // 👈 Increased yBody to place the tractor lower in the larger 60% box
          />
        </div> */}
        ...
        {/* <div style={{
          ...
          right: 0,
          height: '60%',
          // no overflow: hidden — let the SVG bleed
        }}>
          <Forklift
            startX={1100}           // Off-screen right
            palletX={300}            // Where the pallet will be
            scale={0.6}
            groundY={600}           // Adjust so it's visible in the bottom 60%
            approachEndFrame={60}
            departEndFrame={300}
          />
        </div> */}
