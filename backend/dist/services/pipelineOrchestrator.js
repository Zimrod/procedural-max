...
import { segmentTranscriptionIntoSentences, semanticExtractionPipeline } from "../core/segmentation/semanticExtraction.js";
...
export async function runTranscriptionToScenePipeline(rawTranscription, fps = 30) {
    ...
    const finalSceneConfig = buildSceneConfigFromWidgets(narrativeScenes, selectedWidgets, fps, enrichedTranscript);
